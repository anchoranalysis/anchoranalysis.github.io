...
| -tr | Suggests an <span class="optionArg">image dimensions to resize to</span> (e.g. `-tr 1024x768`) or a <span class="optionArg">scaling factor</span> (e.g.`-tr 0.5`)<br>- To preserve aspect ratio: `200x` or `x50` resizes to a particular width/height, and `1000x500+` to resize maximally within these dimensions.<br>- No scaling in the z-dimension is supported.<br>- The order of dimensions is always {@code width}x{@code height} |
